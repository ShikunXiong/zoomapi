...
# create a channel
# response = json.loads(client.chat_channels.create(name="create_test", type=1, members=[{"email":
# "aa@gmail.com"}]).content)
# print(response)
...
# invite
# response = json.loads(client.chat_channels.invite(channelId=my_channel_id, members=[{"email":
# "tjuwangyilin@163.com"}]).content)
# print(response)
